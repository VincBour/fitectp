...
namespace ContosoUniversity.Controllers
{
    ...
    public class StudentController : Controller
    {
        ...
        public ActionResult Edit(int? id)
        {
            ...
            //search for a student and his image with the same id as in parameter in the database
        ...
        {
            //Create object studentViewModel
            StudentEnrollmentViewModel model = new StudentEnrollmentViewModel();
            //Implementation of this studentViewModel with the student with the id parameters
            model.Student = db.Students.FirstOrDefault(s => s.ID == id);
            //Create list of courses
            List<Course> CourseEnrolled = new List<Course>();
            //Adding courses to which the student is already enrolled
            ...
            //Create list with the id of courses of student is already enrolled
            List<int> EnrolledCoursesId = CourseEnrolled.Select(q => q.CourseID).ToList();
            //Add a list that does not contain the courses where the student is already enrolled
